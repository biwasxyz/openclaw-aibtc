...
$SUDO mkdir -p "$INSTALL_DIR/data/workspace/skills/aibtc-lifecycle"
...
# Create entrypoint script for wallet/credential persistence
$SUDO tee entrypoint.sh > /dev/null << 'ENTRYPOINTEOF'
#!/bin/sh
set -e
...
$SUDO tee data/workspace/skills/aibtc-lifecycle/SKILL.md > /dev/null << 'LIFECYCLEEOF'
---
